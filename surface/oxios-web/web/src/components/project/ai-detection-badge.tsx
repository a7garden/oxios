...
export function AiDetectionBadge({ project, onApply, onDismiss }: AiDetectionBadgeProps) {
  ...
  return (
    <div className="flex items-center gap-2 px-3 py-2 rounded-lg border bg-amber-50 dark:bg-amber-950/50 border-amber-300 dark:border-amber-700 text-amber-800 dark:text-amber-300 text-xs animate-in slide-in-from-top-2 fade-in duration-200">
      ...
      <span className="text-amber-600 text-2xs shrink-0">Detected</span>
      <div className="ml-auto flex items-center gap-1 shrink-0">
        <Button
          size="sm"
          variant="ghost"
          className="h-5 px-2 text-2xs text-emerald-700 hover:text-emerald-800 hover:bg-emerald-100"
          onClick={onApply}
        >
        ...
        <Button
          size="sm"
          variant="ghost"
          className="h-5 px-2 text-2xs text-amber-700 hover:text-amber-800 hover:bg-amber-100"
          onClick={onDismiss}
        >
