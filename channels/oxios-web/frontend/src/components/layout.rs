...
pub fn AppLayout() -> Element {
    ...
    let content: Element = match panel() {
        ...
        Panel::Budget     => rsx! { crate::views::budget::BudgetView {} },
        ...
        Panel::CronJobs   => rsx! { crate::views::cron_jobs::CronJobsView {} },
        Panel::Git        => rsx! { crate::views::git::GitView {} },
        ...
        Panel::Sessions   => rsx! { crate::views::sessions::SessionsView {} },
        Panel::Resources  => rsx! { crate::views::resources::ResourcesView {} },
    };
