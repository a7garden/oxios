...
> SUIT/SUITE/Geist Mono loaded (§4); `.dark` + `oxi-theme` FOUC (§8); `dark:`
> sweep + raw-palette → token migration done across components. `dark:prose-invert`
> retained as a documented typography-plugin exception.
