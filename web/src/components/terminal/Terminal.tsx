...
import { FitAddon, Terminal as GhosttyTerminal, init as ghosttyInit } from 'ghostty-web'
    ...
    <div className="flex h-full w-full flex-col bg-background">
      <div className="flex items-center justify-between border-b bg-card px-3 py-1.5 text-xs">
        <div className="flex items-center gap-2">
          <span className="font-mono text-muted-foreground">{shellName ?? '/bin/zsh'}</span>
        ...
        <div className="flex items-center gap-1">
          ...
          {ready ? (
            <Button variant="ghost" size="sm" onClick={onKill} className="h-7 gap-1 px-2 text-xs">
