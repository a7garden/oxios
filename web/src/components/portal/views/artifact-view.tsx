...
// artifact-specific actions (code↔preview toggle, copy, download) and the body
// renderer.
...
export function ArtifactView({ view }: ArtifactViewProps) {
  ...
  const { meta, content, displayMode, key } = view
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="flex items-center justify-end gap-1 border-b px-2 py-1.5">
        ...
        <Button size="icon" variant="ghost" onClick={download} aria-label={t('artifact.download')}>
